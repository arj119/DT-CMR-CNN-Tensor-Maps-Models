# -*- coding: utf-8 -*-
"""tf2train_CasNet_gen_pix_2_pix.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/11i5HAGEP-GJp5VvGU9_gpfXIgcD99ik6
...
def normalise_matrices(array):
    return np.true_divide(array - 127.5, 127.5)

def scale_output(array):
    array = array * SCALE_TARGET
    return array

def load_npz_files(input_list, output_list, dti_param, normalise_output=True):
    ...
    for idx, val in enumerate(output_list):
        if idx == 0:
            ...
            if(normalise_output):
              output_arrays = scale_output(output_arrays)
...
# %%
checkpoint_dir = './checkpoints/training_checkpoint_casNet_generator_pix2pix_4_avgs_input_scaled'
...
# %%
log_dir = "logs/casNetPix2Pix4Avg/"
...
generator.save("./Arjun_generator_weights/CasNetGen4Averages/model_input_scaled.h5", save_format='h5')
